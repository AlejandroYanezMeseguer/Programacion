...
public class Cuenta {
  ...
  private long num_conta;
	  ...
	  private Persona cliente;
	    ...
	    public Cuenta(long num_conta, Persona cliente) {
       ...
       for(int i=0;i<6;i++) {
           ...
           switch(opcion){
	           ...
	           case 1:  Persona p1=new Persona(JOptionPane.showInputDialog("Introduce el nombre: "),
	        		   JOptionPane.showInputDialog("Introduce los apellidos: "),
	        		   JOptionPane.showInputDialog("Introduce tu dni: "));

	        	   Cuenta cr1=new CuentaCorriente(Long.parseLong(JOptionPane.showInputDialog("Introduce la cuenta: ")),
	           p1);
	           ...
	           case 2:
	        	   Persona p2=new Persona(JOptionPane.showInputDialog("Introduce el nombre: "),
	        			   JOptionPane.showInputDialog("Introduce los apellidos: "),
	        			   JOptionPane.showInputDialog("Introduce el dni: "));
	        	   Cuenta ca1=new CuentaAhorro(1.2,1000,Long.parseLong(JOptionPane.showInputDialog("Introduce la cuenta: ")),
	           p2);
